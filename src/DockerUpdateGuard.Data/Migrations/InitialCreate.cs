        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortainerEndpoints_DockerInstances_DockerInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageVersions_RegistryRepositories_RegistryRepositoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ObservedImages_ImageVersions_CurrentImageVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScanRuns_DockerInstances_DockerInstanceId",
                        column: x => x.DockerInstanceId,
                        principalTable: "DockerInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ScanRuns_ObservedImages_ObservedImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContainerSnapshots_DockerInstances_DockerInstanceId",
                        column: x => x.DockerInstanceId,
                        principalTable: "DockerInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContainerSnapshots_ImageVersions_ImageVersionId",
                        column: x => x.ImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContainerSnapshots_ScanRuns_ScanRunId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageRelationships_ImageVersions_BaseImageVersionId",
                        column: x => x.BaseImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImageRelationships_ImageVersions_ChildImageVersionId",
                        column: x => x.ChildImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageRelationships_ScanRuns_ScanRunId",
                        column: x => x.ScanRunId,
                        principalTable: "ScanRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VulnerabilityFindings_ImageVersions_ImageVersionId",
                        column: x => x.ImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VulnerabilityFindings_ScanRuns_ScanRunId",
                        column: x => x.ScanRunId,
                        principalTable: "ScanRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContainerActionRuns_ContainerSnapshots_ContainerSnapshotId",
                        column: x => x.ContainerSnapshotId,
                        principalTable: "ContainerSnapshots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ContainerActionRuns_DockerInstances_DockerInstanceId",
                        column: x => x.DockerInstanceId,
                        principalTable: "DockerInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContainerActionRuns_PortainerEndpoints_PortainerEndpointId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UpdateFindings_ContainerSnapshots_ContainerSnapshotId",
                        column: x => x.ContainerSnapshotId,
                        principalTable: "ContainerSnapshots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UpdateFindings_ImageVersions_RecommendedImageVersionId",
                        column: x => x.RecommendedImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UpdateFindings_ImageVersions_SubjectImageVersionId",
                        column: x => x.SubjectImageVersionId,
                        principalTable: "ImageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UpdateFindings_ObservedImages_ObservedImageId",
                        column: x => x.ObservedImageId,
                        principalTable: "ObservedImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UpdateFindings_ScanRuns_ScanRunId",
                        column: x => x.ScanRunId,
                        principalTable: "ScanRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TagCandidates_UpdateFindings_UpdateFindingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContainerActionRuns_ContainerSnapshotId",
                table: "ContainerActionRuns",
                column: "ContainerSnapshotId");

            migrationBuilder.CreateIndex(
                name: "IX_ContainerActionRuns_DockerInstanceId_RequestedAtUtc",
                table: "ContainerActionRuns",
                columns: new[] { "DockerInstanceId", "RequestedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ContainerActionRuns_PortainerEndpointId_RequestedAtUtc",
                table: "ContainerActionRuns",
                columns: new[] { "PortainerEndpointId", "RequestedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ContainerSnapshots_DockerInstanceId_ContainerId_RecordedAtU~",
                table: "ContainerSnapshots",
                columns: new[] { "DockerInstanceId", "ContainerId", "RecordedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ContainerSnapshots_ImageVersionId",
                table: "ContainerSnapshots",
                column: "ImageVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_ContainerSnapshots_ScanRunId",
                table: "ContainerSnapshots",
                column: "ScanRunId");

            migrationBuilder.CreateIndex(
                name: "IX_DockerInstances_Name",
                table: "DockerInstances",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ImageRelationships_BaseImageVersionId",
                table: "ImageRelationships",
                column: "BaseImageVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageRelationships_ChildImageVersionId",
                table: "ImageRelationships",
                column: "ChildImageVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageRelationships_ChildImageVersionId_BaseImageVersionId_D~",
                table: "ImageRelationships",
                columns: new[] { "ChildImageVersionId", "BaseImageVersionId", "Depth", "RelationshipType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ImageRelationships_ScanRunId",
                table: "ImageRelationships",
                column: "ScanRunId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageVersions_RegistryRepositoryId_Tag_Digest",
                table: "ImageVersions",
                columns: new[] { "RegistryRepositoryId", "Tag", "Digest" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ObservedImages_CurrentImageVersionId",
                table: "ObservedImages",
                column: "CurrentImageVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_PortainerEndpoints_DockerInstanceId",
                table: "PortainerEndpoints",
                column: "DockerInstanceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RegistryRepositories_Registry_Repository",
                table: "RegistryRepositories",
                columns: new[] { "Registry", "Repository" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScanRuns_DockerInstanceId",
                table: "ScanRuns",
                column: "DockerInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanRuns_ObservedImageId",
                table: "ScanRuns",
                column: "ObservedImageId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanRuns_Type_Status_StartedAtUtc",
                table: "ScanRuns",
                columns: new[] { "Type", "Status", "StartedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TagCandidates_UpdateFindingId_Tag_Digest",
                table: "TagCandidates",
                columns: new[] { "UpdateFindingId", "Tag", "Digest" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFindings_ContainerSnapshotId_IsActive",
                table: "UpdateFindings",
                columns: new[] { "ContainerSnapshotId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFindings_ObservedImageId_IsActive",
                table: "UpdateFindings",
                columns: new[] { "ObservedImageId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFindings_RecommendedImageVersionId",
                table: "UpdateFindings",
                column: "RecommendedImageVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFindings_ScanRunId",
                table: "UpdateFindings",
                column: "ScanRunId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFindings_SubjectImageVersionId_IsActive",
                table: "UpdateFindings",
                columns: new[] { "SubjectImageVersionId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_VulnerabilityFindings_ImageVersionId_AdvisoryId_AffectedPac~",
                table: "VulnerabilityFindings",
                columns: new[] { "ImageVersionId", "AdvisoryId", "AffectedPackage", "FixedVersion" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VulnerabilityFindings_ImageVersionId_Severity_IsActive",
                table: "VulnerabilityFindings",
                columns: new[] { "ImageVersionId", "Severity", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_VulnerabilityFindings_ScanRunId",
                table: "VulnerabilityFindings",
                column: "ScanRunId");
        }
