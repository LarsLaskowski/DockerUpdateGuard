...
/// <summary>
/// Registry metadata adapter contract
/// </summary>
public interface IRegistryMetadataClient
{
    #region Methods

    /// <summary>
    /// Determine whether the adapter supports the provided registry
    /// </summary>
    /// <param name="registry">Registry host</param>
    /// <returns>True when the adapter can handle the registry</returns>
