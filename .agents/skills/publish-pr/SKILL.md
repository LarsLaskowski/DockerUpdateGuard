...
7. Create a non-interactive Git commit following `AGENTS.md`: one-line summary under 80 characters, no trailing period, not first person, and a body of 3–5 sentences depending on the number of changes.
